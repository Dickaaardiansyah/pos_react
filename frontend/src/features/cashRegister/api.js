...
export const cashRegisterApi = {
  getCashOutCategories: () => httpClient.get("/cash-register/cash-out-categories"),
  getCashInCategories: () => httpClient.get("/cash-register/cash-in-categories"),

  getActive: () => httpClient.get("/cash-register/active"),
  open: (payload) => httpClient.post("/cash-register/open", payload),
  close: (id, payload) => httpClient.post(`/cash-register/${id}/close`, payload),

  createMovement: (payload) => httpClient.post("/cash-register/movements", payload),
