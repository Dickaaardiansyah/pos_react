...
export function useLabaRugi() {
  ...
  const multiYearQuery = useQuery({
    queryKey: [
      ...
      "income-statement",
      "multi-year",
      { multiYearSpan, multiYearEndYear },
    ],
    queryFn: () =>
      accountingApi.getMultiYearIncomeStatement({
        years: multiYearSpan,
  ...
  const quarterlyQuery = useQuery({
    ...
    queryFn: () =>
      accountingApi.getQuarterlyIncomeStatement({ year: quarterlyYear }),
  ...
  const multiPeriodQuery = useQuery({
    queryKey: [
      ...
      "income-statement",
      "multi-period",
      { multiPeriodStart, multiPeriodEnd },
    ],
    queryFn: () =>
      accountingApi.getMultiPeriodIncomeStatement({
  ...
  return {
    ...
    loading:
      tab === "expenses"
        ...
        : (activeReportQuery?.isLoading ?? false),
    createExpense,
    updateExpense,
    removeExpense,
